    ...
    <form wire:submit="send" class="space-y-6">
        ...
        <x-filament::section>
            <details>
                ...
                <p style="margin-top:8px; color:#526b88;">Click a placeholder to insert it into your message. PUSMS replaces it with each recipient's real details when sending.</p>
